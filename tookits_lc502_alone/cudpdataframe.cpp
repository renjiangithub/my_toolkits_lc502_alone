...
CUdpDataFrame::CUdpDataFrame()
{
    ...
    //    m_IV_string="1234567890123456";
    //    m_IV.append(m_IV_string.toUtf8());
    for(int i=0; i<16; ++i){
        m_IV.append(_uint8ToQByteArray(key[i]).toHex());
    }
}
...
QByteArray CUdpDataFrame::_sendUdpDataJoint()
{
    ...
    sendUdpData.append(this->m_plain_effective_length); //有效长度
